...
- **Esplora REST** (`esplora-handlers`) — wire-shape parity with
  ...
  default on loopback. See [Esplora REST API](https://epochbtc.github.io/satd/esplora.html).
...
- `docs/manual/src/packaging.md` as the authoritative downstream-packager reference.

## Documentation

- [`CORE_DIFFERENCES.md`](../../CORE_DIFFERENCES.md) — catalog of intentional
  deviations from Bitcoin Core.
- [Operator Manual](https://epochbtc.github.io/satd/) — full flag matrix
  and tuning guide.
...
- [`SECURITY.md`](../../SECURITY.md) — disclosure address, signing key matrix,
  threat-model notes.
- [`ROADMAP.md`](../../ROADMAP.md) — unshipped operator features and the ecosystem / mobile strategy.
...
[Operator Manual](https://epochbtc.github.io/satd/) for the v0.1.x line. macOS Apple Silicon
