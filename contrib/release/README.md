...
| `../../scripts/canary/pins.py gate` | Maintainer | Before tagging: fail if a canary pin is more than one major version, or six months, behind upstream without a recorded hold. Policy in [`STABILITY_POLICY.md`](../../STABILITY_POLICY.md), "Keeping the pins current". |
