...
fn field_specs() -> Vec<FieldSpec> {
    ...
    vec![
        ...
        // ---- Stratum ----
        restart!("stratum", stratum),
        restart!("stratumbind", stratum_bind),
        restart!("stratumtlsbind", stratum_tls_bind),
        restart!("stratumtlscert", stratum_tls_cert),
        restart!("stratumtlskey", stratum_tls_key),
        restart!("stratummtls", stratum_mtls),
        restart!("stratummtlsclientca", stratum_mtls_client_ca),
        restart!("stratummtlsclientallow", stratum_mtls_client_allow),
        restart!("stratumaddress", stratum_address),
        restart!("stratumdifficulty", stratum_difficulty),
        restart!("stratummaxconns", stratum_max_conns),
        restart!("stratumallowplaintextremote", stratum_allow_plaintext_remote),
        ...
        restart!("upgradechainstate", upgradechainstate),
