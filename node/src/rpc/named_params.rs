...
pub(crate) const ALL_METHODS: &[&str] = &[
    ...
    "deriveaddresses", "disconnectnode", "dumptxoutset",
    ...
    "getconnectioncount", "getdeploymentinfo", "getdescriptorinfo", "getdifficulty",
    "getibdprogress", "getindexinfo",
    "getmemoryinfo",
    "getmempoolancestors", "getmempooldescendants", "getmempoolentry",
    "getmempoolhistory", "getmempoolinfo", "getmempoolsummary",
    "getmininginfo", "getnettotals",
    "getnetworkhashps", "getnetworkinfo", "getorphaninfo", "getpeerinfo",
    "getpolicyinfo", "getprioritisedtransactions", "getquarantineentry",
    "getquarantineinfo", "getrawmempool",
    "getrawtransaction", "getreorghistory", "getrpcinfo", "getserverstatus",
    "getsatdindexinfo", "getsilentpaymentblockdata", "getstratuminfo", "getsysteminfo", "gettxout",
    "gettxoutproof", "gettxoutsetinfo",
    "getwarnings",
    ...
    "sendmsgtopeer", "sendrawtransaction", "setban", "setmocktime", "setnetworkactive",
    "signrawtransactionwithkey", "stop", "submitblock", "submitheader",
    "submitpackage", "subscribemempool", "syncwithvalidationinterfacequeue",
    "testmempoolaccept", "unsubscribemempool", "uptime",
    "utxoupdatepsbt", "validateaddress", "verifychain", "verifytxoutproof",
